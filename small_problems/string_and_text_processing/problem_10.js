 // input: a word and a text string
 // output:  the text with instances of the word capitalized with asterisks around it.
 // algorithm: Use replace to search for instances of the word using capturing groups and
 // replace with the backreference capitalized with '**' around it.
...
console.log(searchWord('quis', text));
// returns
